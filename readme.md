...
Daily driver: **Hillside D50** — a 50-key split dactyl with an optional YADS dongle. Legacy fallback: **Temper** (36 keys). The remaining keymaps in `config/` (glove80, corneish_zen, planck_rev6) are historical samples inherited from upstream.
...
- **Hillside D50 (primary)** - 50-key split dactyl: 34-key core plus 16 extras, optional YADS dongle, Hyper-3 window-manager keys, tmux prefix thumbs, and a shared physical key vocabulary
